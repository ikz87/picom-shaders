...
vec4 get_pixel_through_camera(vec2 coords, pinhole_camera camera)
{
    ...
    // Following the cylinder EQ (with Y axis as center)
    // x^2 + z^2 = r^2
    float r = window_size.x/(PI/2);
